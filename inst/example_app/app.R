    ...
    shiny::tabsetPanel(
      ...
      shiny::tabPanel(
        ...
        gov_layout(
          ...
          shinyGovstyle::tag_Input("tag6", "Purple", "purple"),
          shinyGovstyle::tag_Input("tag7", "Magenta", "magenta"),
          shinyGovstyle::tag_Input("tag8", "Red", "red"),
          shinyGovstyle::tag_Input("tag9", "Orange", "orange"),
          shinyGovstyle::tag_Input("tag10", "Yellow", "yellow"),
          shiny::tags$br(),
          shiny::tags$br(),
...
server <- function(input, output, session) {
  ...
  # Trigger error if text_area2 is blank
